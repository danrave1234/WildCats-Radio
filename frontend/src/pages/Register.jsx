    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-white via-yellow-50 to-yellow-200 overflow-y-auto">
      <div className="w-full flex flex-col items-center justify-start min-h-screen p-4 py-4 sm:py-6 md:py-8 relative">
        <div className="w-full max-w-sm sm:max-w-md my-auto">
          ...
          <Card className="border-0 shadow-2xl bg-white backdrop-blur-xl overflow-hidden !rounded-none animate-in fade-in-0 slide-in-from-bottom-4 duration-700 ease-out max-h-[calc(100vh-160px)] overflow-y-auto custom-scrollbar">
            <div className="h-3 bg-gradient-to-r from-wildcats-maroon to-wildcats-maroon/70" />
            <CardHeader className="px-4 sm:px-6 pt-3 sm:pt-4 md:pt-6 pb-2 sm:pb-3">
              <div>
                <CardTitle className="text-base sm:text-lg md:text-xl font-bold text-gray-800">Create your account</CardTitle>
            ...
            <CardContent className="px-4 sm:px-6 py-3 sm:py-4 md:py-6 pt-2 sm:pt-3">
