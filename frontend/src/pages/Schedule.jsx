                ...
                <div className="space-y-4">
                  ...
                  {canScheduleBroadcasts && selectedBroadcast.details && (
                    <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
                      <h3 className="text-md font-medium text-blue-800 dark:text-blue-200 flex items-center mb-2">
                        <InformationCircleIcon className="h-5 w-5 mr-1" />
                        Broadcast Details (Staff Only)
                      </h3>
                      <p className="text-blue-700 dark:text-blue-300">{selectedBroadcast.details}</p>
                    </div>
                  )}
                </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
              ...
              <div className="flex space-x-2">
                ...
                <button 
                  onClick={goToToday}
                  className="px-3 py-1 text-sm bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 dark:bg-blue-900 dark:text-blue-200 dark:hover:bg-blue-800"
                >
                  Today
                </button>
                <button 
                    ...
                    <div className="space-y-1 overflow-y-auto max-h-[80px]">
                      {day.broadcasts.map((broadcast) => (
                        <div 
                          ...
                          className="text-xs p-1 rounded bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 cursor-pointer hover:bg-blue-200 dark:hover:bg-blue-800 truncate"
                          title={broadcast.title}
                        >
                          <div className="font-medium truncate">{broadcast.title}</div>
                          <div className="text-xs text-blue-700 dark:text-blue-300">{broadcast.startTime}</div>
                        </div>
                      ))}
                    </div>
                  </div>
