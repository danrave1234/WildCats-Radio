  ...
  return (
    <div className={cn("relative min-h-screen w-full overflow-hidden bg-slate-950 text-slate-100", className)}>
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-x-0 top-1/2 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent opacity-60" />
        <div className="absolute inset-x-8 bottom-16 h-32 rounded-full border border-white/10 opacity-40 blur-2xl" />
      </div>
