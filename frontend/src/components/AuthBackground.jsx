...
const AuthBackground = ({ children, className, contentClassName }) => {
  return (
    <div className={cn("relative min-h-screen w-full overflow-hidden bg-slate-950 text-slate-100 flex items-center justify-center", className)}>
      ...
      <div className={cn("relative z-10 w-full flex items-center justify-center", contentClassName)}>
        {children}
      </div>
    </div>
  )
