          ...
          {notifications.length > 0 && (
            <div className="p-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
              <button
                ...
                className="w-full text-center py-1.5 text-sm font-medium text-maroon-600 hover:text-maroon-700 dark:text-maroon-400 dark:hover:text-maroon-300 hover:bg-maroon-50 dark:hover:bg-maroon-900/20 rounded-md transition-colors"
              >
